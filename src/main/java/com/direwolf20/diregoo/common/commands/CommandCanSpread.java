...
public class CommandCanSpread {
    ...
    public static int getCanSpread(CommandContext<CommandSource> context) {
    ...
    public static int setCanSpread(CommandContext<CommandSource> context, boolean canSpread) {
