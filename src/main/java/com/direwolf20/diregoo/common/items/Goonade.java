...
public class Goonade extends Item {
    public Goonade() {
        super(new Item.Properties().maxStackSize(8).group(DireGoo.itemGroup));
    }
    ...
    private void spawnGoonade(PlayerEntity player, World world, ItemStack itemstack) {
