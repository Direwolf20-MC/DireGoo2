...
public class GeneratorRecipes extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(GOO_DETECTOR_ITEM.get())
                ...
                .addCriterion("has_agd", hasItem(ANTI_GOO_DUST.get()))
                .build(consumer);
        ShapedRecipeBuilder.shapedRecipe(GNT_BLOCK_T1_ITEM.get())
                .key('c', CORE_MELT.get())
                .key('f', CORE_FREEZE.get())
                .key('a', ANTI_GOO_DUST.get())
                .key('t', Items.TNT)
                .key('p', POWERAMP_T1.get())
                .patternLine("aaa")
                .patternLine("ctf")
                .patternLine("apa")
                .addCriterion("has_agd", hasItem(ANTI_GOO_DUST.get()))
                .build(consumer);
        ShapedRecipeBuilder.shapedRecipe(GNT_BLOCK_T2_ITEM.get())
                .key('c', CORE_MELT.get())
                .key('f', CORE_FREEZE.get())
                .key('a', ANTI_GOO_DUST.get())
                .key('t', Items.TNT)
                .key('p', POWERAMP_T2.get())
                .patternLine("aaa")
                .patternLine("ctf")
                .patternLine("apa")
                .addCriterion("has_agd", hasItem(ANTI_GOO_DUST.get()))
                .build(consumer);
        ShapedRecipeBuilder.shapedRecipe(GNT_BLOCK_T3_ITEM.get())
                .key('c', CORE_MELT.get())
                .key('f', CORE_FREEZE.get())
                .key('a', ANTI_GOO_DUST.get())
                .key('t', Items.TNT)
                .key('p', POWERAMP_T3.get())
                .patternLine("aaa")
                .patternLine("ctf")
                .patternLine("apa")
                .addCriterion("has_agd", hasItem(ANTI_GOO_DUST.get()))
                .build(consumer);
        ShapedRecipeBuilder.shapedRecipe(GNT_BLOCK_T4_ITEM.get())
                .key('c', CORE_MELT.get())
                .key('f', CORE_FREEZE.get())
                .key('a', ANTI_GOO_DUST.get())
                .key('t', Items.TNT)
